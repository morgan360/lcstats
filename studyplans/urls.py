...
urlpatterns = [
    ...
    path('stamps/', views.stamp_cards, name='stamp_cards'),
    ...
    path('checkpoint/<int:checkpoint_id>/mark/', views.mark_checkpoint,
    ...
    path('teacher/plan/<int:plan_id>/microbadge/<int:badge_id>/award/',
         views.award_microbadge, name='award_microbadge'),
    ...
    path('teacher/plan/<int:plan_id>/copy/', views.copy_plan, name='copy_plan'),
