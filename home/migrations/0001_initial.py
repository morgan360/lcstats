        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Headline for the news item", max_length=200
                    ),
                ),
                (
                    "content",
                    markdownx.models.MarkdownxField(
                        help_text="Content with markdown and LaTeX support"
                    ),
                ),
                (
                    "publish_date",
                ...
                (
                    "is_pinned",
                    models.BooleanField(
                        default=False, help_text="Pinned items appear at the top"
                    ),
                ),
                (
                    "is_dismissible",
